<template>
	<view class="wrap">
		...
		<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
			...
			<u-form-item :label-position="labelPosition" label="生日" prop="intro">
				<u-calendar v-model="showCalendar" ref="calendar" @change="changeCalendar"></u-calendar>
				<u-input :border="border" placeholder="请选择日期" v-model="model.birthday" type="text" @click="selectBirthday"></u-input>
			</u-form-item>
...
export default {
	...
	methods: {
		...
		changeCalendar(e) {
			if (this.modeCalendar == 'range') {
				this.model.birthday = e.startDate + " - " + e.endDate;
			} else {
				this.model.birthday = e.result;
			}
		},
		selectBirthday(index) {
